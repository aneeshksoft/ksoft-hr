    ...
    <div class="col-md-12 col-sm-12">
        <div class="form-group">
           ...
           <form class="form-auth-small" action="" name="reject_leave" id="reject_leave" method="POST" enctype="multipart/form-data">
            <div class="row clearfix">
                <div class="col-md-12"><div class="alert alert-warning" role="alert">You are <strong>rejecting</strong> this leave request as <strong><?=$res['role']?></strong></div></div>
                <div class="col-md-12 col-sm-12">
                     <div class="form-group">
                        <label>Remarks</label>
          ...
          submitHandler: function(form, e) {
               ...
               swal({
                    ...
                    if (isConfirm) {         
                        $.ajax({
                         type: 'POST',
                         url: base_url + 'user/reject_leave_process',
                         cache: false,
                         async: false,
                         data: form_data,
                         contentType: false,
