            ...
            <div class="card-body">
                <form action="" name="probation_evaluation_form" id="probation_evaluation_form" method="POST" enctype="multipart/form-data">
                    <div class="row">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center text-nowrap">
                                            ...
                                            <?php else : ?>
                                                <?= $probation['extention_start_date'] ?>
                                            <?php endif; ?>
                                        </td>
                                        <td class="text-center text-nowrap">
                            ...
                            <table class="table table-bordered mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-nowrap">Done? (Y/N)</th>
                                    </tr>
                                </thead>
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        <?php if (empty($probation)) : ?>
                                            <th colspan="4"></th>
                                            <th class=" text-center"><button id="add_training_extended_line_item" type="button" class="btn btn-sm btn-success " title="Add One More Item" disabled><i class="fa fa-plus"></i></button></th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <div class="d-flex justify-content-center text-nowrap">
                                                <div class="form-check form-check-inline">
                                                    <input type="radio" class="form-check-input" name="second_assessment_status" id="second_assessment_status_1" value="1">
                                                    <label class="form-check-label" for="second_assessment_status_1">CONFIRMED</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input type="radio" class="form-check-input" name="second_assessment_status" id="second_assessment_status_2" value="2">
                                    ...
                                    <tr>
                                        <th colspan="2">Manager’s Name:</th>
                                        <th colspan="2">Employee’s Name:</th>
                                    </tr>
                                    <tr>
                                        <th colspan="2">Manager’s Signature:</th>
                        ...
                        <?php if (empty($probation) || !empty($probation['second_assessment_status'])) : ?>
                            <div class="col-sm-12">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        <?php if (empty($probation)) : ?>
            ...
            if ($('#training_extended_line_items tr').length == 0) {
                setTimeout(() => {
                    ...
                    // console.log($("#training_extended_line_items input,#training_extended_line_items select"));
        ...
        $('#add_training_first_line_item').click(function() {
            ...
            html += `<tr>
                    ...
                    <td><input type="text" class="form-control form-control-sm" name="hours_to_be_attended[` + training_line_id + `]" id="hours_to_be_attended_` + training_line_id + `"></td>
        ...
        $('#add_training_extended_line_item').click(function() {
            ...
            html += `<tr>
                    ...
                    <td><input type="text" class="form-control form-control-sm" name="hours_to_be_attended_extended[` + training_line_id_extended + `]" id="hours_to_be_attended_extended_` + training_line_id_extended + `" ></td>
            ...
            if (fields_valid) {
                ...
                $("#probation_evaluation_form #trainer_" + training_line_id_extended).rules("add", {
                    required: true,
                });
    ...
    function first_assessment_status_change(value) {
        ...
        <?php if (empty($probation)) : ?>
            switch (value) {
                case '1':
                    $("#extention_start_date,#extention_end_date,#add_training_extended_line_item").prop('disabled', true).val('');
                    $("#first_assessment_status_remark_1").prop('disabled', false).val('');
                    $("#first_assessment_status_remark_2").prop('disabled', true).val('');
                    $("#training_extended_line_items input,#training_extended_line_items select").prop('disabled', true).val('');

                    break;
                case "2":
                    $("#extention_start_date,#extention_end_date,#add_training_extended_line_item").prop('disabled', false).val('');
                    $("#first_assessment_status_remark_1").prop('disabled', true).val('');
