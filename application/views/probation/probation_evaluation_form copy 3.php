                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center text-nowrap">
                                            ...
                                            <?php if (empty($probation)) : ?>
                                                <input type="text" class=" form-control form-control-sm datepicker" name="extention_start_date" id="extention_start_date" value="<?= get_date(addDaysToDate($employee['confirmation_duedate'], 2)) ?>">
                                            <?php else : ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#extention_start_date").on('change', function() {
            var StartDate = $(this).val();
            var EndDate = moment($(this).val(), "DD-MM-YYYY").add(3, 'M').format('DD-MM-YYYY');
            console.log(StartDate)
            console.log(EndDate)
            $('#extention_end_date').val('');
            $('#extention_end_date').datepicker('setStartDate', StartDate);
            $('#extention_end_date').datepicker('setEndDate', EndDate);
        })

        // $("#extention_end_date").on('change', function() {
        //     var selected = $(this).val();
        //     var StartDate = $('#extention_start_date').val();
        //     var EndDate = moment(StartDate, "DD-MM-YYYY").add(3, 'M').format('DD-MM-YYYY');
        //     if (moment(selected).isSameOrAfter(StartDate) && moment(selected).isSameOrAfter(EndDate)) {
