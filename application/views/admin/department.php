...
<div class="row clearfix">
                ...
                <form class="form-auth-small" action="" name="add_department" id="add_department" method="POST" enctype="multipart/form-data">
                    <div class="card mb-3">
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <div class="col-md-3 col-sm-12">                                    
                                    <div class="form-group mt-4">
                                        ...
                                        <a href="<?=base_url('department')?>" class="btn btn-lg btn-danger">Cancel</a>
                                    </div>
                                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                           <div class="table-responsive">
                                <table class="table table-hover dataTable table-custom table-striped m-b-0 c_list" id="department_list">
...
<script type="text/javascript">
    ...
    $(function() {
       ...
       table = $('#department_list').DataTable({
            "ajax": base_url+"admin/department_list_ajax",
            "columns": [
                {"data": "name"},
                {"data": "action"}
            ],
       ...
       $("#add_department").validate({
          rules: {
             name: {
               required:true,
               remote: {
                url: "admin/checkDepartmentExist",
                type: "post"
               }
             }
         },
         ...
         submitHandler: function(form, e) {
               ...
               $.ajax({
                type: 'POST',
                url: base_url + 'admin/department_process',
	cache: false,
	async: false,
	data: form_data,
	contentType: false,
