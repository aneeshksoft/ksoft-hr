            ...
            <div class="card-body">
                <form action="" name="employee_add" id="employee_add" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-12">
                            <div class="form-group">
                                <label>Experience before Enventure <br />(In months)<sup>*</sup></label>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#btn_add_edu').on('click', function() {
            ...
            $("#employee_add .edu-required").each(function() {
            ...
            $("#employee_add .edu-year").each(function() {
        ...
        $('#btn_add_certification').on('click', function() {
            ...
            //validate all fields with particular class
            $("#employee_add .cert-required").each(function() {
                $(this).rules('add', {
                    required: true,
                })
            });
        ...
        $('#add_employment').on('click', function() {
            ...
            //validate all fields with particular class
            $("#employee_add .emp-required").each(function() {
        ...
        $('#btn_add_family').on('click', function() {
            ...
            $("#employee_add .fm-required").each(function() {
            ...
            $("#employee_add .fm-mob").each(function() {
    ...
    function salaryslip_disable() {
        if ($("#employment_history").val() == "yes") {
            ...
            $(
                "#employee_add #salary_slip_last3, #employee_add #salary_breakup"
            ).removeClass("d-none");
...
<script type="text/javascript">
    ...
    function filterFields() {
        ...
        var mrf_id = $("#mrf_id").val();
        $.ajax({
            type: 'POST',
            url: '<?= base_url('employee/filterReferCandidateFields') ?>',
            cache: false,
            async: false,
            data: {
                mrf_id: mrf_id,
            ...
            success: function(response) {
                ...
                if (obj.department_id) {
                    ...
                    switch (department_id) {
                        case '1':
                            // ESG
                            // console.log("case_1")
                            $(".col_work_place_id").show();
                            $(".col_minimum_educational_qualification_id").show();
                            $(".col_education_qualification").hide();
                            $(".col_experiance_in_year").hide();
                            $(".col_experiance_in_year_min").show();
                            $(".col_experiance_in_year_max").show();
                            $(".col_experiance_in_year_relevant").show();
                            $(".col_primary_tool_id").show();
                            $(".col_secondary_tool_id").show();
                            $(".col_track_id").show();
                            $(".col_skills").hide();
                            $(".col_skill_id").show();
                        ...
                        case "2":
                            // SAS
                            // console.log("case_2")
                            $(".col_work_place_id").hide();
                            $(".col_minimum_educational_qualification_id").hide();
                            $(".col_education_qualification").show();
                            $(".col_experiance_in_year").show();
                            $(".col_experiance_in_year_min").hide();
                            $(".col_experiance_in_year_max").hide();
                            $(".col_experiance_in_year_relevant").hide();
                            $(".col_primary_tool_id").hide();
                            $(".col_secondary_tool_id").hide();
                            $(".col_track_id").hide();
                            $(".col_skills").show();
                            $(".col_skill_id").hide();
                ...
                $('#track_id option:not(:first)').remove();
                var tracks = obj.tracks;
                var html = '';
                for (let i = 0; i < tracks.length; i++) {
                    html += '<option value="' + tracks[i].id + '">' + tracks[i].name + '</option>';
                }
                $('#track_id').append(html);
